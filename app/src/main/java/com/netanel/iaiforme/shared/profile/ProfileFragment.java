...
public class ProfileFragment extends Fragment {
    ...
    private final StorageReference storageReference = FirebaseStorage.getInstance().getReference("UsersProfilePic");
    private final CollectionReference uploadPicFireStoreRef = FirebaseFirestore.getInstance().collection("Users");
    User currentUser;
    ...
    private ImageView selectedPicImageView;
    Button  actionsBtn , enterExitBtn;
    private final ManagerNotiAdapter managerNotiAdapter = new ManagerNotiAdapter();
    RecyclerView rvManagerNoti;
    private final CollectionReference managerNotiRef = db.collection("Fcm");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        enterExitBtn.setOnClickListener(v -> changeBetweenFragment(new EnterExitFragment()));
    }
    ...
    public void setBottomSheetProfilePicture(View view) {
        ...
        setProfilePicBtn.setOnClickListener(view12 -> uploadPic());
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK &&
            ...
            Picasso
                    .get()
                    .load(imageFbUri)
                    .transform(new RoundedCornersTransformation(200,
                            0, RoundedCornersTransformation.CornerType.DIAGONAL_FROM_TOP_RIGHT))
        ...
        if (imageFbUri != null) {
            ...
            fileRef.putFile(imageFbUri)
                    .addOnSuccessListener(taskSnapshot -> fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        handler.postDelayed(() -> uploadPicProgress.setProgress(0), 3000);
                        handler = new Handler();
    ...
    public void setUpManagerNotiRecyclerView(View view) {
        ...
        managerNotiRef.get().addOnSuccessListener(queryDocumentSnapshots -> {
    ...
    public void checkUserStatus(){
        userRef.document(userid).get().addOnSuccessListener(documentSnapshot -> {
            ...
            if (user.getStatus().equals("Worker")){
                actionsBtn.setOnClickListener(v -> changeBetweenFragment(new ActionsWorkerFragment()));
            }else if (user.getStatus().equals("Manager")){
                actionsBtn.setOnClickListener(v -> changeBetweenFragment(new ActionsManagerFragment()));
            }
        });
    }
