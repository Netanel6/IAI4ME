...
public class WorkerMainActivity extends AppCompatActivity {
    ...
    private final CollectionReference userNameRef = FirebaseFirestore.getInstance().collection("Users");
    TextView userNameTv;
    ...
    public void getUserName() {
        ...
        userNameRef.document(userid).get().addOnSuccessListener(documentSnapshot -> {
