...
public class SendFcmActivity extends AppCompatActivity {
    ...
    private final CollectionReference fcmSendMessageRef = FirebaseFirestore.getInstance().collection("Fcm");
    Button sendFcmToAllBtn;
    private final Noti noti = new Noti();
    ...
    public void sendMessageToAll() {
        sendFcmToAllBtn.setOnClickListener(v -> {
